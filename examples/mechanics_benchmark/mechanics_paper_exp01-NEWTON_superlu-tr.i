...
[Executioner]
  ...
  petsc_options_iname='-snes_type -ksp_type -pc_type -pc_factor_shift_type -pc_factor_mat_solver_package'
  petsc_options_value=' newtontr   preonly   lu       NONZERO               superlu_dist                '
