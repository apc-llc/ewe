...
[AuxKernels]
  [./auxdistance_outer] type=VolumeNearestNodeDistanceAux  variable=distance_outer  block=1  paired_boundary=2 [../]
  [./auxdistance_inner] type=VolumeNearestNodeDistanceAux  variable=distance_inner  block=1  paired_boundary=1 [../]
...
[BCs]
  [./dispx_fixed] type=PresetBC  variable=dispx  boundary='1 2 3'  value=0 [../]
  [./dispy_fixed] type=PresetBC  variable=dispy  boundary='1 2 3'  value=0 [../]
  [./dispz_fixed] type=PresetBC  variable=dispz  boundary='1 2 3'  value=0 [../]
  #[./dispx_neumann] type=NeumannBC  variable=dispx  boundary='1 2 3'  value=0 [../]
  #[./dispy_neumann] type=NeumannBC  variable=dispy  boundary='1 2 3'  value=0 [../]
  #[./dispz_neumann] type=NeumannBC  variable=dispz  boundary='1 2 3'  value=0 [../]
