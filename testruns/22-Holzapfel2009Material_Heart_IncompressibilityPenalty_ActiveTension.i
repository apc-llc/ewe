...
[Kernels]
  ...
  [./incompressibility_dispx] type=CardiacKirchhoffIncompressibilityPenalty  variable=dispx  component=0  displacements='dispx dispy dispz' gamma=10.0 [../]
  [./incompressibility_dispy] type=CardiacKirchhoffIncompressibilityPenalty  variable=dispy  component=1  displacements='dispx dispy dispz' gamma=10.0 [../]
  [./incompressibility_dispz] type=CardiacKirchhoffIncompressibilityPenalty  variable=dispz  component=2  displacements='dispx dispy dispz' gamma=10.0 [../]
...
[Executioner]
  ...
  solve_type=PJFNK
  petsc_options_iname='-pc_type -pc_hypre_type -pc_hypre_boomeramg_max_iter -mat_mffd_type'
  petsc_options_value=' hypre    boomeramg      8                            ds'
